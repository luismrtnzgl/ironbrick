...
with st.sidebar:
    ...
    app = option_menu(
        ...
        icons=["", "📌", "📌", "📌", "📌"],
        styles = {
            "container": {"background-color": "#FFE04A", "margin-top": "10px","margin-bottom": "10px", "padding": "8px"},
  ...
  # Usar HTML para mostrar la imagen y el texto a la derecha
    st.markdown(
        ...
        <div style="display: flex; align-items: center;">
            <img src="data:image/png;base64,{img_data}" alt="lego" style="width: 200px; height: 150px; margin-right: 20px;">
        </div>
        """,
        unsafe_allow_html=True
    )
